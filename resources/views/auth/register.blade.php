                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="rg" type="text" class="form-control @error('rg') is-invalid @enderror" name="rg" value="{{ old('rg') }}" required>
                        ...
                        <div class="row mb-3">
                            <label for="link_lattes" class="col-md-4 col-form-label text-md-end">{{ __('Link lattes') }}</label>

                            <div class="col-md-6">
                                <input id="link_lattes" type="text" class="form-control @error('link_lattes') is-invalid @enderror" name="link_lattes" value="{{ old('link_lattes') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cidade" type="text" class="form-control @error('cidade') is-invalid @enderror" name="cidade" value="{{ old('cidade') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="uf" type="text" class="form-control @error('uf') is-invalid @enderror" name="cidade" value="{{ old('uf') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="complemento" type="text" class="form-control @error('complemento') is-invalid @enderror" name="complemento" value="{{ old('complemento') }}" required>
